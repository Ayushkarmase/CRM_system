...
@router.get(
    ...
    description="Retrieve all tickets with optional filtering by status, priority, and text search.",
)
def get_tickets(
...
@router.get(
    ...
    description="Returns aggregate ticket counts (Total, Open, In Progress, Closed).",
)
